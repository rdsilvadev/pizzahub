    ...
    <div className="flex flex-wrap flex-col-reverse md:flex-col">
      ...
      <div className="mt-3 mb-6 pb-3 border rounded-md shadow-md w-full">
        ...
        <div className="flex justify-between px-3 my-2">
          ...
          <div className="font-bold text-lg">{cartTotal} USD</div>
        </div>
        <div className="flex justify-between px-3 my-2">
          <div className="font-semibold text-lg text-indigo-700">
            Shipping Fees
          </div>
          <div className="font-bold text-lg">{shippingFees} USD</div>
        </div>
        <div className="flex justify-between px-3 my-2">
          <div className="font-semibold text-lg text-indigo-700">
            Coupon Discount
          ...
          <div className="font-bold text-lg">
            {couponEntry ? (cartTotal * couponEntry.value) / 100 : 0} USD{' '}
            {couponEntry &&
              `(
           ${couponEntry.value}%)`}
          </div>
